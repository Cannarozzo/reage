...
/usuario/editar/#UsuarioId UsuarioConfR PUT DELETE -- ALTERAÇÃO E DELETE
...
postUsuarioInserirR = do
    ...
    returnJson $ (object [pack "resp" .= pack "CREATED"])
...
deleteUsuarioConfR :: UsuarioId -> Handler ()
deleteUsuarioConfR cid = do
    addHeader "Access-Control-Allow-Origin" "*"
    runDB $ delete cid
